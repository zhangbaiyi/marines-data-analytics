...
# Return type is path (str) or None on error
def generate_pdf(_markdown: str = "") -> str | None:
    ...
    try:
        ...
        # Maybe a slightly more descriptive temporary name
        pdf_name = "generated_report.pdf"
        ...
        # Log traceback
        LOGGER.error(f"Error generating or saving PDF: {e}", exc_info=True)
